...
inline const char* const* EnumNamesBuilding_Type() {
    static const char* const names[7]
        = {"Undefined", "City_Hall", "Harvest", "Plant", "Fish", "Produce", nullptr};
    return names;
}

inline const char* EnumNameBuilding_Type(Building_Type e) {
    if (::flatbuffers::IsOutRange(e, Building_Type_Undefined, Building_Type_Produce))
        return "";
...
struct Resource FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    bool Verify(::flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_CODE)
               && verifier.VerifyString(code())
               && VerifyOffsetRequired(verifier, VT_TEXTURE)
               && verifier.VerifyString(texture())
               && VerifyOffsetRequired(verifier, VT_SMALL_TEXTURE)
               && verifier.VerifyString(small_texture()) && verifier.EndTable();
    }
};
...
inline ::flatbuffers::Offset<Resource> CreateResourceDirect(
    ...
    return BFGame::CreateResource(_fbb, code__, texture__, small_texture__);
}
...
inline ::flatbuffers::Offset<Construction_Resource_Pair>
CreateConstruction_Resource_PairDirect(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    const char*                       resource_code = nullptr,
    int32_t                           count         = 0
) {
    auto resource_code__ = resource_code ? _fbb.CreateString(resource_code) : 0;
    return BFGame::CreateConstruction_Resource_Pair(_fbb, resource_code__, count);
}
...
struct Building FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    const ::flatbuffers::Vector<
        ::flatbuffers::Offset<BFGame::Construction_Resource_Pair>>*
    construction_resources() const {
        return GetPointer<const ::flatbuffers::Vector<
            ::flatbuffers::Offset<BFGame::Construction_Resource_Pair>>*>(
            VT_CONSTRUCTION_RESOURCES
        );
    }
    bool Verify(::flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffsetRequired(verifier, VT_CODE)
...
struct BuildingBuilder {
    ...
    void add_human_spawning_delay(float human_spawning_delay) {
        fbb_.AddElement<float>(
            Building::VT_HUMAN_SPAWNING_DELAY, human_spawning_delay, 0.0f
        );
    }
    void add_required_construction_points(float required_construction_points) {
        fbb_.AddElement<float>(
            Building::VT_REQUIRED_CONSTRUCTION_POINTS, required_construction_points, 0.0f
        );
    }
    void add_can_be_built(bool can_be_built) {
        fbb_.AddElement<uint8_t>(
            Building::VT_CAN_BE_BUILT, static_cast<uint8_t>(can_be_built), 0
        );
    }
    void add_construction_resources(
    ...
    explicit BuildingBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline ::flatbuffers::Offset<Building> CreateBuilding(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<
        ::flatbuffers::Offset<BFGame::Construction_Resource_Pair>>> construction_resources
    = 0
) {
...
inline ::flatbuffers::Offset<Building> CreateBuildingDirect(
    ...
    float                             required_construction_points = 0.0f,
    bool                              can_be_built                 = false,
    const std::vector<::flatbuffers::Offset<BFGame::Construction_Resource_Pair>>*
        construction_resources
    = nullptr
) {
    auto code__    = code ? _fbb.CreateString(code) : 0;
    auto texture__ = texture ? _fbb.CreateString(texture) : 0;
    auto construction_resources__
        = construction_resources ? _fbb.CreateVector<
              ::flatbuffers::Offset<BFGame::Construction_Resource_Pair>>(
              *construction_resources
          )
                                 : 0;
...
struct Game_Library FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
    ...
    const ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Building>>* buildings(
    ) const {
        return GetPointer<
            const ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Building>>*>(
            VT_BUILDINGS
        );
    }
    const ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Resource>>* resources(
    ) const {
        return GetPointer<
            const ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Resource>>*>(
            VT_RESOURCES
        );
    }
    bool Verify(::flatbuffers::Verifier& verifier) const {
        return VerifyTableStart(verifier) && VerifyOffset(verifier, VT_BUILDINGS)
               ...
               && verifier.VerifyVectorOfTables(resources()) && verifier.EndTable();
    }
};
...
struct Game_LibraryBuilder {
    ...
    void                              add_buildings(
                                     ::flatbuffers::Offset<
            ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Building>>> buildings
                                 ) {
        fbb_.AddOffset(Game_Library::VT_BUILDINGS, buildings);
    }
    void add_resources(
        ::flatbuffers::Offset<
            ::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Resource>>> resources
    ) {
        fbb_.AddOffset(Game_Library::VT_RESOURCES, resources);
    }
    explicit Game_LibraryBuilder(::flatbuffers::FlatBufferBuilder& _fbb) : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline ::flatbuffers::Offset<Game_Library> CreateGame_Library(
    ::flatbuffers::FlatBufferBuilder& _fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Building>>>
        buildings
    = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<BFGame::Resource>>>
        resources
    = 0
) {
...
inline ::flatbuffers::Offset<Game_Library> CreateGame_LibraryDirect(
    ...
    auto buildings__
        = buildings ? _fbb.CreateVectorOfSortedTables<BFGame::Building>(buildings) : 0;
    auto resources__
        = resources ? _fbb.CreateVectorOfSortedTables<BFGame::Resource>(resources) : 0;
    return BFGame::CreateGame_Library(_fbb, buildings__, resources__);
}
...
inline bool Game_LibraryBufferHasIdentifier(const void* buf) {
    return ::flatbuffers::BufferHasIdentifier(buf, Game_LibraryIdentifier());
}

inline bool SizePrefixedGame_LibraryBufferHasIdentifier(const void* buf) {
    return ::flatbuffers::BufferHasIdentifier(buf, Game_LibraryIdentifier(), true);
}

inline bool VerifyGame_LibraryBuffer(::flatbuffers::Verifier& verifier) {
    return verifier.VerifyBuffer<BFGame::Game_Library>(Game_LibraryIdentifier());
}

inline bool VerifySizePrefixedGame_LibraryBuffer(::flatbuffers::Verifier& verifier) {
